...
<div class="pt-24 pb-12">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center gap-2 text-sm text-[#9CA3AF] mb-6">
            ...
            <a href="{{ route('cart', ['lang' => $langCode]) }}" class="hover:text-[#8B5CF6] transition-colors">{{ __('buttons.cart') }}</a>
            <i class="fas fa-chevron-right text-[10px]"></i>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                <div class="lg:col-span-2 space-y-6">
                    ...
                    <div class="glass rounded-2xl p-6 border border-[rgba(255,255,255,0.06)]">
                        <h3 class="text-white font-semibold mb-4">{{ __('buttons.account_login_title') }}</h3>
                        <a href="#formLogin" data-toggle="collapse" class="text-sm text-[#8B5CF6] hover:text-white transition-colors">{{ __('buttons.click_here_login') }}</a>
                    ...
                    <div class="glass rounded-2xl p-6 border border-[rgba(255,255,255,0.06)]">
                        <h3 class="text-white font-semibold mb-4">{{ __('buttons.billing_details') }}</h3>
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                <label class="block text-sm text-[#9CA3AF] mb-1.5">{{ __('buttons.first_name') }} *</label>
                                <input type="text" name="firstname" class="input-field" required>
                            </div>
                            <div>
                                <label class="block text-sm text-[#9CA3AF] mb-1.5">{{ __('buttons.last_name') }} *</label>
                                <input type="text" name="lastname" class="input-field" required>
                            </div>
                            <div>
                                <label class="block text-sm text-[#9CA3AF] mb-1.5">{{ __('buttons.email') }} *</label>
                                <input type="email" name="email" class="input-field" required>
                            </div>
                            <div>
                                <label class="block text-sm text-[#9CA3AF] mb-1.5">{{ __('buttons.phone') }} *</label>
                                <input type="tel" name="phone" class="input-field" required>
                            </div>
                            <div class="md:col-span-2">
                                <label class="block text-sm text-[#9CA3AF] mb-1.5">{{ __('buttons.address') }} *</label>
                                <input type="text" name="address" class="input-field" required>
                            </div>
                            <div>
                                <label class="block text-sm text-[#9CA3AF] mb-1.5">{{ __('buttons.country') }} *</label>
                            ...
                            <div>
                                <label class="block text-sm text-[#9CA3AF] mb-1.5">{{ __('buttons.postcode') }} *</label>
                                <input type="text" name="postcode" class="input-field" required>
                            </div>
                            <div>
                                <label class="block text-sm text-[#9CA3AF] mb-1.5">{{ __('buttons.city') }} *</label>
                                <input type="text" name="city" class="input-field" required>
                            </div>
                            <div>
                                <label class="block text-sm text-[#9CA3AF] mb-1.5">{{ __('buttons.state') }} *</label>
                ...
                <div>
                    <div class="glass rounded-2xl p-6 border border-[rgba(255,255,255,0.06)] sticky top-24">
                        ...
                        @else
                            <p class="text-sm text-[#9CA3AF] text-center py-6">{{ __('buttons.your_cart_is_empty') }}</p>
                        @endif
                    </div>
                </div>
            </div>
